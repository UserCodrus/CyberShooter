...
protected:
	...
	UPROPERTY(Category = "Effects|Particles", EditDefaultsOnly, BlueprintReadOnly)
	...
	UPROPERTY(Category = "Effects|Sound", EditDefaultsOnly, BlueprintReadOnly)
	...
	UPROPERTY(Category = "Projectile|Bounce", EditDefaultsOnly, BlueprintReadOnly)
		int32 NumBounces;
